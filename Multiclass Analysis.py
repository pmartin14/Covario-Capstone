...
trades_p_score = precision_per_class(trades, trades_thresholds, windows, trades_definition, classes)
quotes_p_score = precision_per_class(quotes, thresholds, windows, quotes_definition, classes)
combined_p_score = precision_per_class(combined, combined_thresholds, windows, combined_definition, classes)
...
trades_r_score = recall_per_class(trades, trades_thresholds, windows, trades_definition, classes)
quotes_r_score = recall_per_class(quotes, thresholds, windows, quotes_definition, classes)
combined_r_score = recall_per_class(combined, combined_thresholds, windows, combined_definition, classes)
...
trades_f1_score = f1_per_class(trades, trades_thresholds, windows, trades_definition, classes)
quotes_f1_score = f1_per_class(quotes, thresholds, windows, quotes_definition, classes)
combined_f1_score = f1_per_class(combined, combined_thresholds, windows, combined_definition, classes)
